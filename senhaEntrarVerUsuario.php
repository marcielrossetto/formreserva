...
if (!empty($_POST['senha'])) {
    ...
    if ($sql->rowCount() > 0) {
        ...
        $erro = "Senha incorreta. Você não tem permissão para cadastrar usuário!";
    }
}
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Senha para ver usuário</h5>
            </div>
                ...
                <form method="POST">
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            id="senha" 
                            name="senha" 
                            placeholder="Digite a senha para ver usuário." 
                            autofocus 
                            required 
                        />
                    </div>
