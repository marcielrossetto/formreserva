...
<?php
 ...
 if (!empty($_POST['senha'])) {
 	...
 	if ($sql->rowCount() > 0) {
        ...
        Você não tem permissão para cadastrar Rodizio!</div>";
 	}
 ...
 <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Senha para cadastrar valor Rodizío</h5>
...
<div class="form-group"  class="container col-md-4">
	...
	Senha:<br><br>
	<input class="form-control"type="password" autofocus name="senha"placeholder="Digite a senha para cadastrar Rodizío."/><br><br>
